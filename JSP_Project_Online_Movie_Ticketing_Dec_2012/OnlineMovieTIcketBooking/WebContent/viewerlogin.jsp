			...
			<div id="foobar">
				...
				<div class="viewer">
					<div class="reel">
						...
						<div class="slide"> <img src="images/3.jpg" alt=""> <span><p>Movies3</p></span> </div></div>
				</div>
			</div>
...
<div id="page">
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
			  <li> <a class="title" align="center">If you are not a registered subscriber, you cant book any ticket.</a> </li>
				 <li> <a class="title" align="center">To continue please click on browse </a> </li>
				<div class="entry">
...
<s:actionerror />
<s:form action="viewer.action" method="post"> <table cellspacing="10">
		<tr><s:submit name="commandButton" value="Browse" id="myinput" align="center" />
        </table>
    <form>
...
<!.......................................................................................>					
		...
		<div id="sidebar">
			<ul>
				...
				<li>
					<h2 class="title" align="center">Please register below...</h2>
					<ul>
						
						
						<li><a href="newRegistersubscriber.action">New Subscriber( Register )</a></li>
