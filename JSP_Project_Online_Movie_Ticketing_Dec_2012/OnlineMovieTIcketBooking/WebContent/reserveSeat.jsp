	...
	<div id="wrapper">
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a>Reserve Seat</a>
				</li>
				<li><a href="viewTickets.action">View Tickets</a>
				</li>
				<li><a href="changepassword.action">Change Password</a>
				</li>
				...
				<table border="1" cellpadding="7">
					<tr>
						...
						<th>
							...
							<s:form action="reserveSeat" method="POST">

								<%@ page import="java.util.ArrayList,edu.iiitb.OnlineMovieTicketBooking.model.*,java.sql.DriverManager,java.sql.ResultSet,java.util.Map,com.opensymphony.xwork2.ActionContext,org.apache.struts2.interceptor.SessionAware"%>
								
								<% Map<String, Object> session2 = ActionContext.getContext().getSession();	%>

								<%
									if (session2.get("seatsAvailable").equals("No Seats")) {
								%>
										No Seats Available in <s:property value="#session.sClass" /> class. Please choose another option
								<%	} else { %>
									<s:checkboxlist list="seats" name="seatstring" />						
						</th>
					</tr>
					<tr>
						<td></td>
						<td><s:submit name="select" value="Submit"></s:submit>				
