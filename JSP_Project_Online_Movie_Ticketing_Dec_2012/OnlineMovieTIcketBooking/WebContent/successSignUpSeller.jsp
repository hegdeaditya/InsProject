...
<title>Online Movie Ticketing - Registration Successful</title>
	...
	<div id="wrapper">
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a>Registered Successfully</a></li>				
			</ul>
		</div>
		<!-- end #menu -->
		<div id="header">
		...
		<table width="100%" rules="none" frame="void" >
			<tr>
				<td>
					<p>Your account was successfully created and is queued for the approval. You will be activated soon by the Administrator. Thank you for your interest.</p>
				</td>				
			</tr>		
