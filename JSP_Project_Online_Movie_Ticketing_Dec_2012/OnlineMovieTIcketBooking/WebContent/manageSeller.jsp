...
<body>
	<div id="wrapper">
		<div id="menu">
			<ul>
				<li><span><a href="<s:url action='adminHome.action'/> ">Home</a> </span>
				</li>
				<li  class="current_page_item"><a href="<s:url action='manageSeller.action' />">Manage
						Sellers</a>
				</li>
				<li><a href="<s:url action='manageSubscriber.action'/>" />Manage
					Subscribers</a>
				</li>
				<li><a href="<s:url action='changepasswordAdmin.action'/>" />Change Password</a>
				</li>
				...
				<div class="errors">
					...
					<table border="1" cellpadding="7" align="center">
						...
						<tr>
							...
							<%
								if (seller.getiRegistrationStatus() == 1) {
							%>
							<td>Active</td>
							<td><a
								href="deactivateSeller.action?sellerID=<%=seller.getiSellerID()%>">Deactivate</a>
							</td>
							<%
								}
							...
							<td>Deactivated</td>
							<td><a
								href="activateSeller.action?sellerID=<%=seller.getiSellerID()%>">Activate</a>
							</td>
							<%
								}
							%>
