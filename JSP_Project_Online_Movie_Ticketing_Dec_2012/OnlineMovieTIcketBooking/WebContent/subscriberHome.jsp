	...
	<div id="wrapper">
		<div id="menu">
			<ul>
				...
				<a href="<s:url action='subscriberHome.action' />">Home</a>
				</span>
				</li>				
				...
				<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
				<li>You are logged in as:  <s:property value="#session['logged-in']" /> 
				
				<!-- <li class="current_page_item"><a>Select City</a></li>  -->
			</ul>
		</div>
		<!-- end #menu -->
		<div id="header">
		...
		<div id="splashRegister">
			...
			<s:form action="cities.action" method="post">
				<table align="center">
					<table>
						<tr>
						...
						<% Map<String, Object> session1 = ActionContext.getContext().getSession();
							ArrayList<String> cityNames=(ArrayList<String>)session1.get("cityNamesArrayList");
							if(cityNames!=null){
							
							%>
						<tr>
							<td><s:select label="Select City" headerKey="-1"
									list="cities" name="city" />
							</td>
						</tr>
						<tr align="right">
							<td><s:submit value="Next" onchange="submit()"></s:submit>
							</td>
						</tr>
					</table>
					<%} else { %>
					<tr>
						<td align="center"><h1>No Theaters added!! Please visit
								us sometime later:)</h1></td>
					</tr>
				</table>
				<%} %>
