...
<s:actionerror />
<s:form action="login2.action" method="post"> <table cellspacing="10">
	<tr><s:textfield  name="username" label="Subscriber Name" id="myinput" size="20" /></tr>
    <tr><s:password name="password" label="Subscriber Password" id="myinput" size="20" /></tr>
    <tr><s:submit name="commandButton" value="Login" id="myinput" align="center" />
			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li><a href="forgotpassword.action">Forgot password ?</a></li>
