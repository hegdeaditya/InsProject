...
<body>
	<div id="wrapper">
		<div id="menu">
			<ul>
				<li><span><a
						href="AdminHome.jsp">Home</a> </span>
				</li>
				...
				<li  class="current_page_item"><a href="adminChangepassword.jsp" />Change Password</a>
				</li>
		...
		<div id="header">
			<div id="logo">
				<h1>
					<a href="#">Change Password Request</a>
				</h1>
			</div>
		...
		<div id="splashRegister">
			...
			<s:actionerror />
			<s:form action="chpwdAdmin.action" method="post">
