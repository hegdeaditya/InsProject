...
<body>
	<div id="wrapper">
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a>Successfully Booked</a>
				</li>
		...
		<div id="header">
			<div id="logo">
				<h1>
					<a href="#">Tickets booked Successfully! </a>
				</h1>
			</div>
	...
	<s:if test="#session.login != 'true'">
			...
			<table align="center">
				<tr>
					<td>
						<p>Your tickets are booked. But due to network issue, tickets were not mailed. You can receive your tickets on the counter.</p>
					</td>
				</tr>
				<tr>
					<td>
						To book more tickets, please go to Home Page.
					</td>
				</tr>
