...
<body>
	<div id="wrapper">
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a>Select Movie</a></li>
	...
	<s:if test="#session.login != 'true'">
			...
			<s:form action="movies.action" method="post">
				<table align="center">
				<tr>
					<td>
						Selected city :
				...
				<%@ page
						...
						<% Map<String, Object> session1 = ActionContext.getContext().getSession();
							ArrayList<String> movieNames=(ArrayList<String>)session1.get("moviesnames");
							if(movieNames!=null){
							
							%>
				<tr>
					<td>
						<s:select label="Movie" headerKey="-1" list="lstmovies" name="movie" />
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<td align="center"><h1>No Movies added to the selected Theater!! Please select someother theater </h1></td>
					</td>
				</tr>
				<%} %>
			</table>
