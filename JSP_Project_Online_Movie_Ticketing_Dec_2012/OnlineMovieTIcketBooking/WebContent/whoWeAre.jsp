			...
			<div id="page-bgbtm">
				<div id="content1">
					<div class="post">
						...
						<div class="entry">
							<p><img src="images/abhilash.jpg" width="143" height="143" alt="" class="alignleft border" />He is <strong>MT2012003 </strong>, a free, fully standards-compliant, authorized ticket booking website. You can now enjoy the combo offers with discount on tickets this Valentine.</p>
					...
					<div class="post">
						...
						<div class="entry">
							<p><img src="images/anuj.jpg" width="143" height="143" alt="" class="alignleft border" />Sed lacus. Donec lectus. Nullam pretium nibh ut turpis. Nam bibendum. In nulla tortor, elementum vel, tempor at, varius non, purus. Mauris vitae nisl nec metus placerat consectetuer. Donec ipsum. Proin imperdiet est. Phasellus <a href="#">dapibus semper urna</a>. Pellentesque ornare, consectetuer nisl felis ac diam.</p>
						</div>
					</div>
					<div class="post">
						<h2 class="title"><a href="#">Phasellus pellentesque turpis </a></h2>
						<div class="entry">
							<p><img src="images/vijay.jpg" width="143" height="143" alt="" class="alignleft border" />Sed lacus. Donec lectus. Nullam pretium nibh ut turpis. Nam bibendum. In nulla tortor, elementum vel, tempor at, varius non, purus. Mauris vitae nisl nec metus placerat consectetuer. Donec ipsum. Proin imperdiet est. Pellentesque ornare, orci in consectetuer hendrerit, urna elit eleifend nunc.</p>
						</div>
					</div>
