...
<title>subscribermainpage</title>
	...
	<div id="two-columns">
		<div class="col1">
			<div id="foobar">
				...
				<div class="viewer">
					<div class="reel">
						<div class="slide"> <img src="images/1.jpg" alt=""> <span><p>movie1</p></span> </div>
						<div class="slide"> <img src="images/2.jpg" alt=""> <span><p>movie2</p></span></div>
		...
		<div class="col2">
			<blockquote>&#8220;&nbsp;Movies --- <U>Entertainment</u> &nbsp;&#8221;</blockquote>
		</div>
	</div>
</div>
<div id="page">
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
				 <h2 class="title" align="center"> Movie,city,theatre selection </h2>
				<div class="entry">
...
<!add the code here>
	...
	<h2>Welcome <s:property value="#session['logged-in']" />...!</h2>

<s:form action="cities.action" method="post"><table cellspacing="10">
