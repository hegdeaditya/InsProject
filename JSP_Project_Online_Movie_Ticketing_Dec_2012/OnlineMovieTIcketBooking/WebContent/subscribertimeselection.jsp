...
<body>
	<div id="wrapper">
		<div id="menu">
			<ul>
				<li><span><a href="subscriberHome.action">Home</a> </span></li>
				<li class="current_page_item"><a>Select Time</a>
				</li>
	...
	<s:if test="#session.login != 'true'">
			...
			<s:form action="times.action" method="post">
				...
				<table cellspacing="10" align="center">
					...
					<tr>
						<td>
							Selected date :
						<s:property value="#session['dDate']" />
						</td>
						
					</tr>
					<tr>
						<td>
							<s:select label="Select time" headerKey="-1" list="times"
							name="time" />
						</td>
