...
<body>
	<div id="wrapper">
		<div id="menu">
			<ul>
				<li><span><a href="home.action">Home</a> </span></li>				
				<li><a href="newRegistersubscriber.action">Sign Up as Subscriber &nbsp;&nbsp;&nbsp;&nbsp;</a></li>
				<li class="current_page_item"><a href="newRegisterseller.action">Sign Up Theatre Owner</a></li>
		...
		<div id="splashRegister">
			...
			<!-- Main Part starts here -->
						...
						<s:form action="signUPSellerProcessing.action" method="post"
							validate="true" onsubmit="return validateForm()">

					<table width="100%" rules="none" frame="void">
						<tr>
							<td>
								<s:textfield name="name" label="Seller Name *" />
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td>
								...
								<s:password name="password1" label="Choose Password*"  />
							</td>
						</tr>
						<tr>
							<td>
								<!-- <s:textfield name="password2" label="Retype Password *" /> -->
