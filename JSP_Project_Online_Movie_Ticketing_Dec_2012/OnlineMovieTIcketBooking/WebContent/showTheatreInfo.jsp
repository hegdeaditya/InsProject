...
<body>
	<div id="wrapper">
		<div id="menu">
			<ul>
				<li ><span><a
						href="sellerHome.action">Home</a> </span></li>
				<li><a href="<s:url action='addTheatre.action' />">Add
						Theatre</a></li>
				<li class="current_page_item"><a > Theatre Info </a></li>
				<li><a href="changepasswordSeller.action">Change Password</a></li>
				<li><a href="<s:url action='logout.action' />">Log Out</a></li>
				<li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
				
				<li>You are logged in as: <s:property
						value="#session['sEmail']" /></li>
			</ul>
		</div>
		<!-- end #menu -->
		<div id="header">
		...
		<div id="splash">
			...
			<table align="center">
				<tr>
					<td>	
						<s:label name="name" label="Theatre ID" />
						<s:property value="iTheatreID" />
					</td>
				</tr>
				<tr>
					<td>	
						<s:label label="Theatre Name" />
						<s:property value="theaterName" />
					</td>
				</tr>
				<tr>
					<td>	
						<s:label label="Address" />
					</td>
				</tr>
				<tr>
					<td>	
						<s:label label="Phone Number" />		
					</td>
				</tr>
				<tr>
					<td>	
				...
				<tr>
					<td>	
						<s:label label="Total Seats" />
						<s:property value="iNumberOfSeates" />
					</td>
				</tr>							
