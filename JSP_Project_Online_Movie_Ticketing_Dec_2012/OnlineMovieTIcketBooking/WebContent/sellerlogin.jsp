	...
	<div id="two-columns">
		<div class="col1">
			<div id="foobar">
				...
				<div class="viewer">
					<div class="reel">
						<div class="slide"> <img src="images/3.jpg" alt=""> <span><p>Movies1 </p></span> </div>
						<div class="slide"> <img src="images/2.jpg" alt=""> <span><p>Movies2</p></span></div>
						<div class="slide"> <img src="images/1.jpg" alt=""> <span><p>Movies3</p></span> </div>
					</div>
				</div>
			</div>
...
<s:actionerror />
<s:form action="login3.action" method="post"> <table cellspacing="10">
	<tr><s:textfield  name="username" label="Seller Name" size="20" /></tr>
    <tr><s:password name="password" label="Seller Password" size="20" /></tr>
    <tr><s:submit name="commandButton" value="Login" align="center" />
			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li><a href="newRegisterseller.action">New Seller( Register )</a></li>
