...
public class DB {
	...
	public static void main(String[] args) {
		db.createDatabase("jspproject");
		db.runScript(RuntimeSettings.scriptSql9);
		
		db.runScript(RuntimeSettings.scriptSql);
		db.runScript(RuntimeSettings.scriptSql1);
		db.runScript(RuntimeSettings.scriptSql2);
		db.runScript(RuntimeSettings.scriptSql3);
		db.runScript(RuntimeSettings.scriptSql4);
		db.runScript(RuntimeSettings.scriptSql5);
		db.runScript(RuntimeSettings.scriptSql6);
		db.runScript(RuntimeSettings.scriptSql7);
			}
